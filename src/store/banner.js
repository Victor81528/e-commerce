const state = {
  data: [
    ...
    },
    {
      ...
      linkTitle: 'Discover the new collection',
      link: process.env.VUE_APP_PATH + '/women/clothing'
    },
    {
      title: '2022 SPRING',
    ...
    },
    {
      ...
      link: process.env.VUE_APP_PATH + '/men/shoes'
    }
  ]
}
